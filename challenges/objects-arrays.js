...
class Dino {
  constructor(name, food, weight, height, timePeriod){
    this.name = name;
    this.food = food;
    this.weight= weight;
    this.height = height;
...
let rex = new Dino('tyrannosaurus', 'carnivorous', '7000kg', '12m', 'Late Cretaceious');
let stego = new Dino('stegosaurus', 'herbivorous', '2000kg', '9m', 'Late Jurassic');
let velo = new Dino('velociraptor', 'carnivorous', '15kg', '1.8m', 'Late Cretaceious');

// How much did tyrannosaurus weigh?
console.log(rex.weight);

// What was the diet of a velociraptor?
console.log(velo.food);

// How long was a stegosaurus?
console.log(stego.height);

// What time period did tyrannosaurus live in?
console.log(rex.timePeriod);


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
console.log(rex.rawr());
...
zooAnimals.forEach(function(current){
	animalNames.push(current.animal_name + ", " + current.scientific_name);
});
